...
function doIt() {
	...
	for ($i = 1; $i < count($patternNames) + 1; $i++) {
		$destination = './newpat' . $i . '/newpat' . $i . '.htm';
		
		$contents = '<body style="font: 11pt monospace; margin-left: 110px; text-indent: -100px">' . "\n";
		$contents .= '<p><i>Titles and categories scraped by algoritm from originak source:</i></p>' . "\n";
		...
		*/
		...
		'/apl' . $i . '.htm</a> - requires US $5/month subscription to access</p><br>' . "\n";
		
		$contents .= '<p><i>Summaries of content, keywords and links generated by algorithms:</i></p>' . "\n";
